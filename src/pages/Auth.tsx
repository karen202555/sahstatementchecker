...
const Auth = () => {
  ...
  return (
    <div className="relative flex min-h-screen flex-col items-center px-4 overflow-auto">
      <img src={authBg} alt="" className="absolute inset-0 w-full h-full object-cover object-top pointer-events-none" />

      {/* Logo — top center */}
      <div className="relative z-10 mt-10 mb-5 flex justify-center">
        <img alt="Statement Checker" className="w-[250px] md:w-[300px] h-auto drop-shadow-md" src={logo} />
      </div>

      {/* Spacer to push card lower — eyes stay visible */}
      <div className="flex-1 min-h-[8vh] md:min-h-[12vh]" />
